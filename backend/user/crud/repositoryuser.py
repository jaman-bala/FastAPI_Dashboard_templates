...
class SendEmailVerify:
    ...
    def sendVerify(token):
        email_address = "ermekoffdastan@gmail.com"  # type Email
        email_password = "hyez qgqb akgp eyxi "  # If you do not have a gmail apps password, create a new app with using generate password. Check your apps and passwords https://myaccount.google.com/apppasswords

        # create email
        msg = EmailMessage()
        msg['Subject'] = "Email subject"
        msg['From'] = email_address
        msg['To'] = "ermekoffdastan@gmail.com"  # type Email
        msg.set_content(
            f"""\
    verify account        
